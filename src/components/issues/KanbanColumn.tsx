...
function KanbanColumn({status, group}: KanbanColumnProps) {
    ...
    return (
        <div ref={setNodeRef} className={`w-[318px] shrink-0 flex flex-col bg-linear-to-b from-hover-subtle to-surface pt-3 px-2 rounded-lg ${isOverColumn ? 'ring-1 ring-brand' : ''}`}>
