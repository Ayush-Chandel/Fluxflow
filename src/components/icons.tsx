...
function createIcon(displayName: string, viewBox: string, paths: React.ReactNode, defaultColor = "currentColor") {
  const Icon: React.FC<IconProps> = ({ size = 16, color = defaultColor, style, ...props }) => (
    <svg
      ...
      // inline style wins over parent CSS (e.g. shadcn Button's [&_svg]:size-4)
...
export const CollapseArrowIcon = createIcon(
  "CollapseArrowIcon",
  "0 0 16 16",
...
// Issue status icons (Linear-style). A stroked ring + a pie-slice fill whose
// arc length reflects progress; both driven by the `color` prop.
function createStatusIcon(displayName: string, pieD: string, defaultColor = "currentColor") {
  const Icon: React.FC<IconProps> = ({ size = 16, color = defaultColor, style, ...props }) => (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path fill={color} stroke="none" d={pieD} transform="translate(3.5,3.5)" />
    </svg>
  );
  Icon.displayName = displayName;
  return Icon;
...
export const BacklogIcon = createIcon(
  "BacklogIcon",
  "0 0 14 14",
  ...
  "lch(68.75% 3.577 260.65)"
);

export const TodoIcon = createStatusIcon("TodoIcon", "M 3.5,3.5 L3.5,0 A3.5,3.5 0 0,1 3.5, 0 z", "lch(68.75% 0 139.088)");

export const InProgressIcon = createStatusIcon("InProgressIcon", "M 3.5,3.5 L3.5,0 A3.5,3.5 0 0,1 3.5, 7 z", "lch(80% 90 85)");
...
export const CancelledIcon = createIcon(
  "CancelledIcon",
  "0 0 14 14",
  <path
    fillRule="evenodd"
...
// Issue priority icons (Linear-style).
export const NoPriorityIcon = createIcon(
  "NoPriorityIcon",
  "0 0 16 16",
  <>
...
export const UrgentPriorityIcon = createIcon(
  "UrgentPriorityIcon",
  "0 0 16 16",
...
export const HighPriorityIcon = createIcon(
  "HighPriorityIcon",
  "0 0 16 16",
  <>
...
export const MediumPriorityIcon = createIcon(
  "MediumPriorityIcon",
  "0 0 16 16",
  <>
    <rect x="1.5" y="8" width="3" height="6" rx="1" />
...
export const LowPriorityIcon = createIcon(
  "LowPriorityIcon",
  "0 0 16 16",
  <>
    <rect x="1.5" y="8" width="3" height="6" rx="1" />
...
// Diagonal arrows pointing outward to opposite corners — expand the modal.
...
// Diagonal arrows pointing inward from opposite corners — collapse the modal.
export const MinimizeIcon = createIcon(
  ...
  <>
    ...
    <path fillRule="evenodd" clipRule="evenodd" d="M2.28298 14.7772C1.9918 15.0716 1.51699 15.0741 1.22244 14.783C0.928164 14.4919 0.925529 14.017 1.21658 13.7225L4.40115 10.4998H2.69998C2.28576 10.4998 1.94998 10.1641 1.94998 9.74984C1.95006 9.3357 2.28581 8.99984 2.69998 8.99984H6.24978C6.44866 8.99984 6.63941 9.07896 6.78005 9.21957C6.92067 9.36018 6.99974 9.55098 6.99978 9.74984V13.2498C6.99978 13.6641 6.66399 13.9998 6.24978 13.9998C5.83557 13.9998 5.49978 13.6641 5.49978 13.2498V11.5223L2.28298 14.7772Z" />
  </>,
  "lch(40% 1 282 / 1)"
);
...
// Unassigned member — a user glyph inside a dashed ring.
export const AssigneeIcon = createIcon(
  "AssigneeIcon",
  "0 0 16 16",
  <>
